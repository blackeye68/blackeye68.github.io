...
* Pretty Good Privacy
    ...
    * Symmetric functions use 128-bit or higher keys and the asymmetric functions
...
* Hashing
    ...
    * Hash-based Message Authentication Code (HMAC)
        ...
        * HMAC-SHA1
        * HMAC-SHA256
    * Digital signatures prevent collisions from being used to spoof the integrity of a
    message
